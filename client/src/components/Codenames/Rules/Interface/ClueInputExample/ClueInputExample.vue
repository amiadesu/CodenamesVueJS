...
export default defineComponent({
    ...
    methods: {
        ...
        sendClue() {
            ...
            this.interfaceData.clues[this.interfaceData.player.state.teamColor].push(this.textClue + " - " + this.numberClue);
            if (this.interfaceData.clues.red.length > 100) {
                this.interfaceData.clues.red.splice(0, 1);
            }
            this.textClue = "";
            this.numberClue = 0;
            this.randomizeCluePlaceholder();
            this.interfaceData.gameProcess.masterTurn = false;
        },
        listenForUpdates() {
